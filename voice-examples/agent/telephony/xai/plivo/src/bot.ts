...
- end_call: End the current phone call. Use this when the user says goodbye, asks to hang up, or the conversation is clearly finished.
...
- "Alright, I'll end the call now. Goodbye!" then call end_call
